...
public class DocumentBusinessBean extends com.idega.business.IBOServiceBean implements DocumentBusiness {
	...
	private String encodeFontStyle(Font font) {
		...
		if (font.isBold()) {
			s.append(MarkupTags.CSS_VALUE_BOLD).append(",");
		}
		if (font.isItalic()) {
			s.append(MarkupTags.CSS_VALUE_ITALIC).append(",");
		}
		if (font.isUnderlined()) {
			s.append(MarkupTags.CSS_VALUE_UNDERLINE).append(",");
		}
		if (font.isStrikethru()) {
			s.append(MarkupTags.CSS_VALUE_LINETHROUGH);
		}
